...
using DAL;
using DayTrader.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using DayTrader.Helpers;

namespace DayTrader.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from DayTrader", message);
