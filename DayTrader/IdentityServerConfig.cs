...
namespace DayTrader
{
    ...
    {
        public const string ApiName = "DayTrader_api";
        public const string ApiFriendlyName = "DayTrader API";
        public const string DayTraderClientID = "DayTrader_spa";
